package gov.gsa.dcoi.saml.config;
...
import gov.gsa.dcoi.security.SAMLUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public KeyManager keyManager() {
		...
		Resource storeFile = loader.getResource("classpath:/samlKeystore.ks");
		String storePass = "testing123";
	...
	public MetadataGenerator metadataGenerator() {
		...
		metadataGenerator.setEntityId("gov:dcoi.spring.test");
